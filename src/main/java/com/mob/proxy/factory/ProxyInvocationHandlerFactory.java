...
public class ProxyInvocationHandlerFactory {
    ...
    public Object createProxy(
            final Class<?> interfaceClass, final ProxyMethodHandler proxyMethodHandler) {
        return Proxy.newProxyInstance(
                proxyMethodHandler.getClass().getClassLoader(),
                new Class<?>[] {interfaceClass},
                getProxyInvocationHandler(proxyMethodHandler));
    }

    protected ProxyInvocationHandler getProxyInvocationHandler(
